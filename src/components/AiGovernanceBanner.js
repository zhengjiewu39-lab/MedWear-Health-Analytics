  ...
  return (
    ...
    >
      ...
      <Box component="span" sx={{ display: 'block', mt: 0.5, fontSize: '0.85rem' }}>
        {t('AI 融合异常检测、预测性提示与研究信号（attentionScore）模块，自动生成干预建议；所有建议须经医师或管理者批准后方可进入医生报告与体检预约流程。非诊断性输出，需专业人员审核。',
          'AI fuses anomaly detection, predictive signals and research-signal (attentionScore) modules to auto-generate intervention suggestions; all suggestions require physician or administrator approval before entering the doctor report and exam booking workflow. Non-diagnostic — requires professional review.')}
      </Box>
    </Alert>
  );
}
