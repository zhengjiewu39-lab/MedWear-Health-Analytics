...
export const NAV_EN = {
  ...
  '临床验证': 'Exploratory simulation',
  '探索性模拟': 'Exploratory simulation',
  '系统': 'System',
  '临床筛查': 'Research Signal Integration',
  '临床筛查中心': 'Research Signal Integration',
  '异常检测': 'Anomaly Detection',
  'AI 干预': 'AI Intervention',
  'AI 临床助手': 'Clinical AI Assistant',
  '预测性提示': 'Predictive signals',
  '预测分析': 'Predictive signals',
  '医生报告': 'Doctor Report',
