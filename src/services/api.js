...
export const researchApi = {
  ...
  getWearableDataset: () => api.get('/research/wearable/dataset'),
  getWearableResults: () => api.get('/research/wearable/results'),
  getEvaluationFramework: () => api.get('/research/framework'),
  getEvaluationSupplement: () => api.get('/research/evaluation-supplement'),
  regenerateEvaluationSupplement: () => api.post('/research/evaluation-supplement/regenerate'),
  runWearableEvaluation: () => api.post('/research/wearable/evaluate'),
