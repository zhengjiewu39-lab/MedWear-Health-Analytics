...
export const ADMIN_QUICK_ACTIONS = [
  ...
  { title: '研究信号整合', title_en: 'Research Signal Integration', desc: '领域加权研究信号 · BHI 分层', desc_en: 'Domain-weighted research signals · BHI tiers (exploratory — outside primary manuscript scope)', path: '/screening', color: '#b45309' },
