      ...
      {doc?.framework && (
        <Box sx={{ display: 'flex', gap: 0.5, flexWrap: 'wrap', mb: 2 }}>
          <Chip
            ...
            color="secondary"
            label={isEn
              ? `${doc.framework.benchmark_name || 'Benchmark-v3'} · n=${doc.framework.benchmark_n || 5000}`
              : `${doc.framework.benchmark_name_zh || doc.framework.benchmark_name || 'Benchmark-v3'} · n=${doc.framework.benchmark_n || 5000}`}
          />
