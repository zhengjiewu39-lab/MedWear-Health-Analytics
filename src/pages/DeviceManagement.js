...
function DeviceManagement() {
  ...
  return (
    <Box>
      <Typography variant="h5" fontWeight={700} gutterBottom>我的设备</Typography>
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>已连接 {devices.length} 台设备 · 全部在线</Typography>
            ...
            <Card sx={{ borderTop: 3, borderColor: 'success.main' }}>
              <CardContent>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2 }}>
                  ...
                  <Chip label="在线" size="small" color="success" sx={{ ml: 'auto' }} />
                </Box>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1.5 }}>
                  <Typography variant="body2" color="text.secondary">电量</Typography>
                ...
                <Typography variant="caption" color="text.secondary">同步: {d.lastSync}</Typography>
