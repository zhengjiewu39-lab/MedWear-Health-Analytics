...
**Manuscript follows system (do not reverse-edit code for Word):** run `npm run docs:manuscript-sync` → copy from [`docs/ARTICLE-FOLLOW-SYSTEM.md`](docs/ARTICLE-FOLLOW-SYSTEM.md). Freeze tag: `medwear-manuscript-v1.2.3`.
