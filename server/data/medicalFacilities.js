...
const { sanitizeFacilityWebsite } = require('../geo/website');
...
const FACILITY_DB = [
  ...
  facility(15, { type: 'hospital', name: '山东大学齐鲁医院', level: '三甲', address: '历下区文化西路107号', lat: 36.651, lng: 117.038, rating: 4.8, phone: '0531-82169114', website: 'https://www.qiluhospital.com.cn', departments: ['健康管理中心', '肿瘤科', '心内科'], licenseNo: '鲁卫医证字[2019]第3701020101号', licenseAuthority: '山东省卫生健康委员会', licenseValidUntil: '2027-12-15', practiceScope: '综合医院/健康管理' }),
  // ── 专业体检中心 ──
  ...
  facility(103, { type: 'checkup', name: '瑞慈体检上海陆家嘴机构', level: '专业体检', address: '浦东新区陆家嘴环路1000号', lat: 31.235, lng: 121.505, rating: 4.6, phone: '400-900-5959', website: 'https://www.rich-healthcare.com', departments: ['全身体检', '女性专项', '心脑血管'], licenseNo: '沪卫医证字[2022]第3101150666号', licenseAuthority: '上海市卫生健康委员会', licenseValidUntil: '2029-05-31', practiceScope: '健康检查/预防保健', orgCode: '91310115MA03ZZZZZ' }),
  facility(104, { type: 'checkup', name: '慈铭体检广州天河中心', level: '专业体检', address: '天河区体育西路103号', lat: 23.135, lng: 113.324, rating: 4.5, phone: '400-660-1517', website: 'https://www.ciming.com', departments: ['团体体检', '肿瘤早筛', '入职体检'], licenseNo: '粤卫医证字[2021]第4401060555号', licenseAuthority: '广东省卫生健康委员会', licenseValidUntil: '2028-10-31', practiceScope: '健康检查', orgCode: '91440106MA04AAAAA' }),
  // ── 门诊部 / 诊所（可预约体检）──
  facility(201, { type: 'clinic', name: '和睦家医疗北京朝阳诊所', level: '涉外医疗', address: '朝阳区将台路2号', lat: 39.970, lng: 116.490, rating: 4.8, phone: '400-891-9191', website: 'https://www.ufh.com.cn', departments: ['全科', '儿科', '体检'], licenseNo: '京卫医证字[2018]第1101050444号', licenseAuthority: '北京市卫生健康委员会', licenseValidUntil: '2027-09-30', practiceScope: '全科医疗/儿科/预防保健', orgCode: '91110105MA05BBBBB' }),
  facility(202, { type: 'clinic', name: '卓正医疗深圳蛇口医疗中心', level: '高端门诊', address: '南山区工业三路1号', lat: 22.485, lng: 113.920, rating: 4.7, phone: '400-613-6288', website: 'https://www.distinctclinic.com', departments: ['全科', '皮肤科', '体检'], licenseNo: '粤卫医证字[2020]第4403050333号', licenseAuthority: '深圳市卫生健康委员会', licenseValidUntil: '2028-03-31', practiceScope: '全科/皮肤科/健康咨询', orgCode: '91440305MA06CCCCC' }),
  // ── 医学检验机构 ──
  ...
  facility(303, { type: 'lab', name: '艾迪康医学检验中心（北京）', level: '第三方检验', address: '昌平区生命科学园路29号', lat: 40.098, lng: 116.278, rating: 4.5, phone: '400-608-2808', website: 'https://www.adicon.com.cn', departments: ['PCR检测', '病理', '精准医疗'], licenseNo: '京卫医证字[2021]第1101140999号', licenseAuthority: '北京市卫生健康委员会', licenseValidUntil: '2029-02-28', practiceScope: '医学检验科/临床基因扩增', orgCode: '91110114MA09FFFFF' }),
  // ── UK / international (for IP geo outside China) ──
  facility(401, { type: 'hospital', name: 'University Hospital Coventry', level: 'NHS', address: 'Clifford Bridge Road, Coventry CV2 2DX', lat: 52.421, lng: -1.438, rating: 4.4, phone: '+44 24 7696 4000', website: 'https://www.uhcw.nhs.uk', departments: ['Outpatients', 'Diagnostics', 'Health checks'], country: 'United Kingdom', licenseNo: 'NHS Trust', licenseAuthority: 'CQC', licenseValidUntil: '2029-12-31', practiceScope: 'Acute hospital / diagnostics' }),
  facility(402, { type: 'hospital', name: 'University College Hospital London', level: 'NHS', address: '235 Euston Road, London NW1 2BU', lat: 51.525, lng: -0.135, rating: 4.5, phone: '+44 20 3456 7890', website: 'https://www.uclh.nhs.uk', departments: ['Outpatients', 'Imaging', 'Preventive health'], country: 'United Kingdom', licenseNo: 'NHS Trust', licenseAuthority: 'CQC', licenseValidUntil: '2029-12-31', practiceScope: 'Tertiary hospital' }),
  facility(403, { type: 'checkup', name: 'Bupa Health Centre London', level: 'Private checkup', address: 'Battle Bridge House, 300 Gray\'s Inn Road, London', lat: 51.529, lng: -0.120, rating: 4.3, phone: '+44 345 600 3458', website: 'https://www.bupa.co.uk', departments: ['Health assessment', 'Screening'], country: 'United Kingdom', licenseNo: 'Private provider', licenseAuthority: 'CQC', licenseValidUntil: '2029-12-31', practiceScope: 'Health assessments' }),
  facility(404, { type: 'checkup', name: 'Nuffield Health Warwickshire Hospital', level: 'Private checkup', address: 'The Chase, Old Milverton Lane, Leamington Spa', lat: 52.310, lng: -1.555, rating: 4.4, phone: '+44 1926 427971', website: 'https://www.nuffieldhealth.com', departments: ['Health assessment', 'Diagnostics'], country: 'United Kingdom', licenseNo: 'Private provider', licenseAuthority: 'CQC', licenseValidUntil: '2029-12-31', practiceScope: 'Hospital / health checks' }),
  facility(405, { type: 'hospital', name: 'Guy\'s Hospital', level: 'NHS', address: 'Great Maze Pond, London SE1 9RT', lat: 51.503, lng: -0.087, rating: 4.5, phone: '+44 20 7188 7188', website: 'https://www.guysandstthomas.nhs.uk', departments: ['Outpatients', 'Diagnostics'], country: 'United Kingdom', licenseNo: 'NHS Trust', licenseAuthority: 'CQC', licenseValidUntil: '2029-12-31', practiceScope: 'Acute hospital' }),
];
...
function findNearbyFacilities(lat, lng, { limit = 15, maxKm = 800, type = null } = {}) {
  return FACILITY_DB
    ...
    .map(f => ({
      ...
      website: sanitizeFacilityWebsite(f.name, f.website),
