...
app.get('/api/methodology', (req, res) => {
  ...
  return res.json({
    ...
    framework: {
      ...
      layers: [
        { id: 'L0', title: 'Wearable proxy signals', title_zh: '可穿戴代理信号' },
        { id: 'L1', title: 'Individualized robust MAD anomaly', title_zh: '个体化稳健 MAD 异常' },
        { id: 'L2', title: 'Research signal integration (exploratory — outside primary manuscript scope)', title_zh: '研究信号整合（探索性 — 不在稿件主范围）' },
      ],
    },
    markdown: parts.join('\n\n---\n\n'),
  });
